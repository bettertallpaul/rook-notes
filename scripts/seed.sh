...
post '{
  ...
  "labels": [{"name": "getting-started", "source": "user"}, {"name": "docs", "source": "user"}]
}'
...
post '{
  ...
  "labels": [{"name": "meetings", "source": "user"}, {"name": "sprint", "source": "user"}]
}'
...
post '{
  ...
  "labels": [{"name": "devops", "source": "user"}, {"name": "reference", "source": "user"}]
}'
...
post '{
  ...
  "labels": [{"name": "books", "source": "user"}, {"name": "engineering", "source": "user"}]
}'
...
post '{
  ...
  "labels": [{"name": "cooking", "source": "user"}, {"name": "personal", "source": "user"}]
}'
...
post '{
  ...
  "labels": [{"name": "engineering", "source": "user"}, {"name": "reference", "source": "user"}]
}'
